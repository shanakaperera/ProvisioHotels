                ...
                <table class="w-100">
                  ...
                  <%
                  			...
                  			Map<BigDecimal, Integer> nightsWithPrice = HolidayRatesUtil
                  					.fetchRoomRatesForDates(res.getHotelRoom().getHotel().getId(), res.getHotelRoom().getId(), DateFormatUtil.format(res.getCheckin()), DateFormatUtil.format(res.getCheckout()));
