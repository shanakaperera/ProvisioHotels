...
<%@page import="com.provisio.utils.HolidayRatesUtil"%>
...
<c:set var="bodyContent">
	...
	<div class="container py-5">
		<div class="row">
			...
			Map<BigDecimal, Integer> nightsWithPrice = HolidayRatesUtil.fetchRoomRatesForDates(hotel.getId(), Integer.parseInt(data.get("room_size")), bookingDates[0].trim(), bookingDates[1].trim());
			...
			for (Map.Entry<BigDecimal, Integer> entry : nightsWithPrice.entrySet()) {
				...
				subTotal = subTotal.add(entry.getKey().multiply(BigDecimal.valueOf(entry.getValue())));
			}
					...
					<div class="card-body p-4">
						...
						<div class="text-block pt-3 pb-0">
							<table class="w-100">
								<tbody>
									<tr>
										<th class="fw-normal py-2"><%=String.join(", ", nightsText)%></th>
