		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-7 mb-5 mb-md-0">
					<form class="form" id="contact-form" method="POST" action="${initParam.appUrl}/contact-us">
						<div class="controls">
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-4">
					...
					$('#contact-form').submit(function(evt) {
					    ...
					    $.ajax({
							...
							success : function(success) {
								$('#message-alert').html('<div class="alert alert-info" role="alert">'+success.responseText+'</div>');
							},
							error : function(error) {
								$('#message-alert').html('<div class="alert alert-info" role="alert">'+error.responseText+'</div>');
							}
						});
