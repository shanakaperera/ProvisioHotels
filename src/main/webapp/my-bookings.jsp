		            ...
		            <div class="row">
		              <div class="col-lg-4 align-self-center mb-4 mb-lg-0">
		                ...
		                <p class="text-sm text-muted"><%= res.getHotelRoom().getRoom().getType() %></p><span class="badge badge-pill p-2 badge-secondary-light">
		                	<%= DateFormatUtil.format(res.getCheckin(), "EEEE dd, YYYY")+" - "+ DateFormatUtil.format(res.getCheckout(), "EEEE dd, YYYY") %>
		                </span>
		              </div>
		              <div class="col-lg-8">
		                <div class="row">
		                  ...
		                  <div class="col-6 col-md-4 col-lg-3 py-3">		                   
		                    ...
		                    <p class="text-sm fw-bold mb-0"><%= DateFormatUtil.format(res.getBookedDate(), "EEEE dd, YYYY") %></p>
		                  </div>
